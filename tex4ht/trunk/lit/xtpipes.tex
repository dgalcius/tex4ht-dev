...
\def\javaclog{\jobname.javac.log}
\Needs{"
    echo  > \javaclog
"}
...
\AtEndDocument{\Needs{"
  cd \WD
  ;
  javac -verbose -Xlint:unchecked xtpipes/*.java
        -d ../\XTPIPES. 2>>\javaclog
  ;
  javac -verbose -Xlint:unchecked xtpipes/*/*.java
        -d ../\XTPIPES. 2>>\javaclog
  ;
...
% 
%% System call: mv xtpipes.dtd /home/4/gurari/xtpipes.dir/xtpipes/lib/xtpipes.dtd
%% \expandafter\AddFile\BIN{xtpipes.dtd}{xtpipes\Slash lib}
\AddFileXX{xtpipes.dtd}{\XTPIPES xtpipes/lib/xtpipes.dtd}
%
%% System call: mv Xtpipes.java work.dir/xtpipes/Xtpipes.java
%\AddFile{Xtpipes.java}{xtpipes}
\AddFileXX{Xtpipes.java}{\WD xtpipes/Xtpipes.java}
...
>>>
%% System call: mv xtpipes.java.java work.dir/xtpipes.java
\Needs{"mv xtpipes.java.java \WD xtpipes.java"}
...
%% System call: mv XtpipesPrintWriter.java work.dir/xtpipes/XtpipesPrintWriter.java
\AddFileXX{XtpipesPrintWriter.java}{\WD xtpipes/XtpipesPrintWriter.java}
...
%% System call: mv xtpipes-map.dtd /home/4/gurari/xtpipes.dir/xtpipes/lib/xtpipes-map.dtd
%%\expandafter\AddFile\BIN{xtpipes-map.dtd}{xtpipes\Slash lib}
\AddFileXX{xtpipes-map.dtd}{\XTPIPES xtpipes/lib/xtpipes-map.dtd}
...
%%System call: mv FileInfo.java work.dir/xtpipes/FileInfo.java
\AddFileXX{FileInfo.java}{\WD xtpipes/FileInfo.java}
...
%% System call: mv InputObject.java work.dir/xtpipes/InputObject.java
\AddFileXX{InputObject.java}{\WD xtpipes/InputObject.java}
...
%% System call: mv XtpipesUni.java work.dir/xtpipes/XtpipesUni.java
\AddFileXX{XtpipesUni.java}{\WD xtpipes/XtpipesUni.java}
...
%%System call: mv xtpipes-default.4xt /home/4/gurari/xtpipes.dir/xtpipes/lib/xtpipes-default.4xt
%%\expandafter\AddFile\BIN{xtpipes-default.4xt}{xtpipes\Slash lib}
\AddFileXX{xtpipes-default.4xt}{\XTPIPES xtpipes/lib/xtpipes-default.4xt}
...
%% System call: mv ScriptsManager.java work.dir/xtpipes/util/ScriptsManager.java
\AddFileXX{ScriptsManager.java}{\WD xtpipes/util/ScriptsManager.java}
...
%% System call: mv ScriptsManagerLH.java work.dir/xtpipes/util/ScriptsManagerLH.java
\AddFileXX{ScriptsManagerLH.java}{\WD xtpipes/util/ScriptsManagerLH.java}
...
%      ;
%      cp xtpipes/lib/*  ../\HOME texmf/tex4ht/xtpipes/.
% "}}
% }
...
cd work.dir ;
mkdir -p bin;
 javac -Xlint:unchecked  -d bin  xtpipes/*.java  2>>\javaclog ;
 javac -Xlint:unchecked  -d bin  xtpipes/util/*.java 2>>\javaclog ;
 javac -Xlint:unchecked  -d bin  *.java 2>>\javaclog ;
cd bin;
 jar cf xtpipes.jar *;
cd ..;
cd xtpipes;
