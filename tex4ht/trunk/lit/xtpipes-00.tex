...
\def\AddFileC#1#2{%
   ...
   \bgroup
     \def\Slash{/}%
     \xdef\EndDir{\ifx \dir\empty \else \dir/\fi
                #2/%
             \ifx\ext\empty
                  \if !#1!\else #1\fi
             \else \ext\fi}%
...
\AtEndDocument%
{%
 % \Needs{"mkdir /home/4/gurari/xtpipes.dir/xtpipes"}%
 % \Needs{"mkdir /home/4/gurari/xtpipes.dir/xtpipes/lib"}%
  \Needs{"mkdir -p \XTPIPES/xtpipes"}%
  \Needs{"mkdir -p \XTPIPESLIB"}%
}
...
% 
%\expandafter\AddFile\BIN{xtpipes.dtd}{xtpipes/lib}
\def\MYdir{\XTPIPES}
\AddFile{xtpipes.dtd}{xtpipes/lib}
...
%\expandafter\AddFile\BIN{xtpipes-map.dtd}{xtpipes/lib}
\def\Mydir{\XTPIPES}
\AddFile{xtpipes-map.dtd}{xtpipes/lib}
...
%\expandafter\AddFile\BIN{xtpipes-default.4xt}{xtpipes/lib}
\def\MYdir{\XTPIPES}
\AddFile{xtpipes-default.4xt}{xtpipes/lib}
...
\def\MYdir{\WD}
\AddFile{ScriptsManager.java}{xtpipes/util}
...
\def\MYdir{\WD}
\AddFile{ScriptsManagerLH.java}{xtpipes/util}
...
\AtEndDocument{\Needs{%
    "cd \XTPIPES
     ...
     jar cf tex4ht.jar *
     ;
     mkdir -p ../\TEXFOURHT/texmf/tex4ht/bin
     ;
     mv tex4ht.jar ../\TEXFOURHT/texmf/tex4ht/bin/.
     ;
     mkdir -p ../\TEXFOURHT/texmf/tex4ht/xtpipes
     ;
     cp xtpipes/lib/* ../\TEXFOURHT/texmf/tex4ht/xtpipes/.
"}}
}
