...
\Needs{"
    javac -verbose HtJsml.java -d \XTPIPES. 2>>\javaclog
"}
...
\Needs{"
    javac -verbose GroupMn.java -d \XTPIPES. 2>>\javaclog
"} 
...
\Needs%
{"
    javac -verbose -classpath \XTPIPES. JsmlMathBreak.java -d \XTPIPES. 2>>\javaclog
"}
...
\Needs{"
    javac -verbose JsmlFilter.java -d \XTPIPES. 2>>\javaclog
"} 
